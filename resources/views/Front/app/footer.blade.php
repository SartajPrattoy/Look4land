                ...
                <div class="widget-a">
                    ...
                    <div class="w-footer-a">
                        <ul class="list-unstyled">
                            <li class="color-a">
                                <span class="color-text-a">@lang('app.email') :</span> <a href="mailto:contact@example.com">taj.emon@gmail.com</a>
                            </li>
                            <li class="color-a">
                                <span class="color-text-a">@lang('app.number') :</span> <a href="tel:+99361000000"> +8801303429231</a>
                            </li>
                        </ul>
                    </div>
                </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="h3">
                    Made by <a class="color-b text-decoration-underline" href=" ">Bracu</a>
                </div>
            </div>
        </div>
    </div>
