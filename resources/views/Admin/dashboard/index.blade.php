        ...
        <div class="col-md-6">
            <div class="card">
                <div class="card-body">
                    ...
                    <p class="card-text">Total visitors: 500</p>
                    <!-- Add more metrics or dynamic data here -->
                </div>
            </div>
        </div>
        <div class="col-md-6">
            <div class="card">
                <div class="card-body">
                    ...
                    <p class="card-text">Additional data here...</p>
                    <!-- Add more metrics or dynamic data here -->
                </div>
            </div>
        </div>
                ...
                <div class="card-body py-0 px-0 px-sm-3">
                  <div class="row align-items-center">
                    ...
                    <div class="col-5 col-sm-7 col-xl-8 p-0">
                      ...
                      <h4 class="mb-1 mb-sm-0">WELCOME TO Look4land</h4>
                ...
                <div class="card-body">
                  ...
                  <div class="row">
                    <div class="col-8 col-sm-12 col-xl-8 my-auto">
                      ...
                      <h6 class="text-muted font-weight-normal">Original sales</h6>
                    </div>
